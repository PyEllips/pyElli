...
``pyElli`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pyElli``'s files. While this mechanism can
...
#. Install |pre-commit|_::
   ...
   ``pyElli`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pyElli
.. _issue tracker: https://github.com/<USERNAME>/pyElli/issues
.. <-- end -->

![pyElli logo](https://github.com/PyEllips/pyElli/blob/master/logo/logo_dark.svg#gh-dark-mode-only)
![pyElli logo](https://github.com/PyEllips/pyElli/blob/master/logo/logo_light.svg#gh-light-mode-only)

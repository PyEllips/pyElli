...
\end{pmatrix}
$$
and define the ellipsometry parameters $\psi$ and $\Delta$ with 
$$
...
Documentation and commented examples are bundled with the program.
...
The code was validated against results presentend in reference~\onlinecite{Fujiwara}.

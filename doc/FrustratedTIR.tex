...
\footnote{The demonstration uses the fact that $k_{z1}$ is real, and that $k_{z2}$ is either real or purely complex. The two cases are considered separately and lead to the result.}.
%
...
.
$$
With lossless materials, we should have $R+T=1$.
It can indeed be demonstrated from the expressions of $r$ and $t$. 
The demonstration uses the relations 
$|r_{bs}|^2 + k_{zb}'/k_{zs}' |t_{bs}|^2=1$
and 
$|r_{sf}|^2 + k_{zs}'/k_{zf}' |t_{sf}|^2=1$
to show that
$k_{zb}'/k_{zf}' |t_{bs}t_{sf}|^2 = (1-|r_{bs}|^2)(1-r_{sf}|^2)$.

...
n_a = 1.0
n_g = 1.5
air = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_a))
glass = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_g))
...
SiO2 = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_SiO2))
TiO2 = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_TiO2))

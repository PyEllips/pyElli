...
# Incidence angle
Phi_b = arcsin((Kx)/n_b)
Phi_n = arcsin((complex(Kx/n)))

# Wave vector:
kz_f = n_f*k0*cos(Phi_i)
kz_n = k0*sqrt(complex(n**2 - Kx**2))
...
t_nfp = cos(Phi_i)*(1-r_nfp)/cos(Phi_n)

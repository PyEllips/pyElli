...
uniaxialMaterialRef = Berreman4x4.UniaxialMaterial(Berreman4x4.DispersionLess(n_o),
...
for θ_E in θ_E_list:
    ...
    uniaxialMaterialRef.setRotation(R)
    back.setMaterial(uniaxialMaterialRef)
...
θ_E_list = [0, pi/4, pi/2]  #  2nd Euler angle

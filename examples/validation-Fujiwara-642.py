...
filmMaterialRef = Berreman4x4.UniaxialMaterial(Berreman4x4.DispersionLess(n_o),
                                               Berreman4x4.DispersionLess(n_e))
R = Berreman4x4.rotation_Euler((Phi_E, Theta_E, 0))
filmMaterial = filmMaterialRef
filmMaterial.setRotation(R)
print("\nPermittivity tensor of the anisotropic film (eq 6.63, p. 241):")
print(filmMaterial.getTensor(500))
"""
...
air = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_i))
...
silicon = Berreman4x4.IsotropicMaterial(Berreman4x4.DispersionLess(n_t))

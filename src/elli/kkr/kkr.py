...
def _calc_kkr(
    ...
    Args:
        ...
        trafo (_type_): The transformation function.
    ...
    odd_im, odd_x = t[1::2], x[1::2]
    even_im, even_x = t[::2], x[::2]
    for i, x_i in enumerate(x):
        if i % 2 == 0:
            integral[i] = trafo(odd_im, odd_x, x_i)
        else:
            integral[i] = trafo(even_im, even_x, x_i)

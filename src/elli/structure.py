...
class RepeatedLayers(AbstractLayer):
    ...
    def __init__(self, layers: List[AbstractLayer], repetitions: int, before: int = 0, after: int = 0) -> None:
        ...
        'before', 'after' : see method set_repetitions()
        """
...
class Structure:
    ...
    * layer succession
    ...
    def __init__(self, front: Material, layers: List[Layer], back: Material) -> None:
        ...
        'layers' : layer list, see set_layers()
    ...
    def set_front_material(self, material: Material) -> None:
    ...
    def get_permittivity_profile(self, lbda) -> List[Tuple[float, npt.NDArray]]:
